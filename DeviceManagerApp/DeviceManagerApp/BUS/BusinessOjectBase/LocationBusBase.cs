...
namespace DeviceManagerApp.BUS.BusinessOjectBase
{
    public class LocationBusBase
    {
        ...
        {
            return LocationDataLayer.GetRecordCountDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
        }
        ...
        /// </summary>
        public static List<LocationModel> SelectSkipAndTakeDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, int rows, int startRowIndex, out int totalRowCount, string sortByExpression)
        {
            totalRowCount = GetRecordCountDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
            sortByExpression = GetSortExpression(sortByExpression);
            return LocationDataLayer.SelectSkipAndTakeDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted, sortByExpression, startRowIndex, rows);
        }
        ...
        /// </summary>
        public static List<LocationModel> SelectSkipAndTakeDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, int rows, int startRowIndex, string sortByExpression)
        {
            sortByExpression = GetSortExpression(sortByExpression);
            return LocationDataLayer.SelectSkipAndTakeDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted, sortByExpression, startRowIndex, rows);
        }
        ...
        /// </summary>
        public static List<LocationModel> SelectAllDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted)
        {
            return LocationDataLayer.SelectAllDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
        }

        /// <summary>
        /// Selects records based on the passed filters as a collection (List) of Location sorted by the sort expression.
        /// </summary>
        public static List<LocationModel> SelectAllDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, string sortExpression)
        {
            List<LocationModel> objLocationCol = LocationDataLayer.SelectAllDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
            return objLocationCol;
        }
