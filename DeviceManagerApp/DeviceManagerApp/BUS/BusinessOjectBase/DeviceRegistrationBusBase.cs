...
namespace DeviceManagerApp.BUS.BusinessOjectBase
{
    public class DeviceRegistrationBusBase
    {
        ...
        {
            return DeviceRegistrationDataLayer.GetRecordCountDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
        }
        ...
        /// </summary>
        public static List<DeviceRegistrationModel> SelectSkipAndTakeDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, int rows, int startRowIndex, out int totalRowCount, string sortByExpression)
        {
            totalRowCount = GetRecordCountDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
            sortByExpression = GetSortExpression(sortByExpression);
            return DeviceRegistrationDataLayer.SelectSkipAndTakeDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted, sortByExpression, startRowIndex, rows);
        }
        ...
        /// </summary>
        public static List<DeviceRegistrationModel> SelectSkipAndTakeDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, int rows, int startRowIndex, string sortByExpression)
        {
            sortByExpression = GetSortExpression(sortByExpression);
            return DeviceRegistrationDataLayer.SelectSkipAndTakeDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted, sortByExpression, startRowIndex, rows);
        }
        ...
        {
            return DeviceRegistrationDataLayer.SelectAllDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
        }

        /// <summary>
        /// Selects records based on the passed filters as a collection (List) of DeviceRegistration sorted by the sort expression.
        /// </summary>
        public static List<DeviceRegistrationModel> SelectAllDynamicWhere(int? id, string name, string image, string description, DateTime? createdDate, int? createdUserId, bool? isDeleted, string sortExpression)
        {
            List<DeviceRegistrationModel> objDeviceRegistrationCol = DeviceRegistrationDataLayer.SelectAllDynamicWhere(id, name, image, description, createdDate, createdUserId, isDeleted);
            return objDeviceRegistrationCol;
        }
